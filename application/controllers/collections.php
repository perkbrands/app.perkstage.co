...
class Collections extends CI_Controller {
    ...
    */	
	...
	function index()
	{
		...
		$data['collection_listing']=$this->collection->collection_listing();
		$data['listing_data']=$this->collection->collection_listing();
		$data['allaccount']=$this->collection->get_account();
		$data['allwebsites']=$this->collection->get_website();			
	...
	{		
		...
		{		
			...
			$this->collection->do_upload($file_name);
		}
		
		$data['query']=$this->collection->collection_add();
		
		$data['listing_data']=$this->collection->collection_listing();
		$data['collectionaccount']=$this->collection->select_collection_account();
		$data['collectionwebsite']=$this->collection->select_colletion_website();
		$data['allaccount']=$this->collection->get_account();
		$data['allwebsites']=$this->collection->get_website();
	...
	public function update_collection_design()
	{
		...
		$data['all_design']=$this->collection->design_all();
		$data['design_collection']=$this->collection->collection_design_update();
		$data['listing_data']=$this->collection->collection_manage_listing();
		$data['query']=$this->collection->design_update();
		$data['page_design']=$this->collection->select_page_design();
		$data['post_design']=$this->collection->select_post_design();
		$data['calendar_design']=$this->collection->select_calendar_design();
	...
	public function update_default_design()
	{
		...
		$data['return_id']=$this->input->post('hidden_id');
		$data['all_design']=$this->collection->design_all();
		$data['default']=$this->collection->design_default_update();
		$data['page_design']=$this->collection->select_page_design();
		$data['post_design']=$this->collection->select_post_design();
		$data['calendar_design']=$this->collection->select_calendar_design();
	//	$this->load->view('admin/collection_manage',$data);							
	...
	public function update_design()
	{
		...
		$data['return_id']=$this->input->post('hidden_id');
		$data['all_design']=$this->collection->design_all();
		$data['collection_title']=$this->collection->collection_title();
		$data['default_page_design']=$this->collection->default_page_design();
		$data['listing_data']=$this->collection->collection_manage_listing();
		$data['page_design']=$this->collection->select_page_design();
		$data['post_design']=$this->collection->select_post_design();
		$data['calendar_design']=$this->collection->select_calendar_design();
	...
	public function design_search()
	{
		...
		$data['search_design']=$this->collection->search_design();
		$data['design_data']=$this->collection->design_select();
		$json_data=$data['design_data'];
		$data['all_design_data']=$this->collection->design_all();
		$data['design_type']=$this->collection->design_type();
		$all_design=$data['search_design'];
		$data['list']=$this->collection->collection_manage_listing();
	...
	public function collection_manage()
	{
		...
		$data['page_design']=$this->collection->select_page_design();
		$data['post_design']=$this->collection->select_post_design();
		$data['query']=$this->collection->design_collection();
		$data['calendar_design']=$this->collection->select_calendar_design();
		$data['default_page_design']=$this->collection->default_page_design();
		$data['default_post_design']=$this->collection->default_post_design();
		$data['default_calendar_design']=$this->collection->default_calendar_design();
		$data['design_all_types']=$this->collection->select_type_all();
		$this->load->view('admin/collection_manage',$data);			
	...
	{		
		$this->load->model('collection');		
		$data['all_design']=$this->collection->design_all();
		$data['query']=$this->collection->selectone_onedesign();
		$data['listing_data']=$this->collection->collection_manage_listing();
		$this->load->view('admin/collection_manage',$data);							
	}
	...
	{
		$this->load->model('collection');		
		$data['query']=$this->collection->profile_collection();
		$data['listing_data']=$this->collection->collection_listing();
		$data['allaccount']=$this->collection->get_account();
		$data['allwebsites']=$this->collection->get_website();			
		$this->load->view('admin/collections',$data);							
	...
	{
		$this->load->model('collection');		
		$data['query']=$this->collection->delete_collection();
		$data['listing_data']=$this->collection->collection_listing();
	...
	public function collection_search()
	{
		...
		$data['listing_data']=$this->collection->search_collection();
		$data['allaccount']=$this->collection->get_account();
	...
	{
		$this->load->model('collection');		
		$data['listing_data']=$this->collection->collection_all();
		$data['allaccount']=$this->collection->get_account();
		$data['allwebsites']=$this->collection->get_website();			
		$this->load->view('admin/collections',$data);							
	}
	...
	{
		$this->load->model('collection');	
		$data['query']=$this->collection->selectone_collection();
		$data['designcollection']=$this->collection->design_collection();
		$data['listing_data']=$this->collection->collection_listing();
		$data['collectionaccount']=$this->collection->select_collection_account();
		$data['collectionwebsite']=$this->collection->select_colletion_website();
		$data['allaccount']=$this->collection->get_account();
		$data['allwebsites']=$this->collection->get_website();
		$data['count_designs']=$this->collection->select_count_page_design();
