...
if($this->uri->segment(2)=='website_file_controller'){
$manage=true;
}
                            ...
                            <ul>
                             ...
                             <?php if($this->session->userdata('status_both')=='' || ($this->session->userdata('role_id')!=2 && $this->session->userdata('assigned_roles')!='multiple')){ ?>
                              ...
                              <?php } ?>  
                                ...
                                <li><a href="<?php echo base_url();?>connection_controller">Connections</a></li>
                                <?php } ?>
                            </ul>
                            <?php } ?>
										...
										if($manage) {
											...
											if($option)
												...
												array(
													...
													<ul>
													<li><a href='/content/websites/pages/manage/format-bold'>Bold</a></li>
													<li><a href='/content/websites/pages/manage/format-italic'>Italic</a></li>
													<li><a href='/content/websites/pages/manage/format-headings'>Headings</a></li>
													</ul>												
													", 
													"insert" => "<a href='/content/websites/pages/insert'>Insert</a>
													<ul>
													<li><a href='/content/websites/pages/manage/insert-link'>Link</a></li>
													</ul>													
													", 
													"view" => "<a href='/content/websites/pages/view'>View</a>", 
													"undo" => "<a href='/content/websites/pages/undo'>Undo</a>",
													"Save" => "<a id='save_editor' href='javascript:void(0)'>Save</a>",
													"Cancel" => "<a id='cancel_editor' href='javascript:void(0)'>Cancel</a>"
												);
