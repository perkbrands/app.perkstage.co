...
<body>
<?php if(isset($collectionaccount) && $collectionaccount!='')
  {
...
?>
  ...
  <nav id="mp-menu" class="mp-menu" >
            <div class="mp-level">
                <h2 class="icon icon-world">Collections</h2>
                
<form action="<?php echo base_url(); ?>collections/collection_search" method="post" enctype="multipart/form-data" name="search_form" id="search_form1">
                	<ul class="leftPaneFilters">
                             ...
                             <li id="searchButtonLI">
                                ...
                                <li><a href="<?php echo base_url(); ?>collections/all_collection"><button type="button" />View All</button></a></li>
                         </ul>
                    </form>
                    <div class="leftPaneFiltersDetails">
                                <p><?php echo count($listing_data);  ?>  Collection(s)</p>
                            </div>
                    
                	<ul class="cardsBox">                                 
								
                               <?php  if(isset($query) && $query!='') { ?>                               	
                                 <a href="<?php echo base_url(); ?>collections/collection/new">
							     <li id="new_collection" >
                                  <div class="plusSign">+</div>
                                    <div class="plusSignText">New Collection</div>
                                ...
                                <?php if(!empty($query)) {?> 
                                <li<?php if($row->collection_id==$query[0]->collection_id ) { ?>class="selected" <?php } ?>>
								<?php } 
								
								else {?> <li<?php if($row->collection_id==$this->uri->segment(3)) { ?> class="selected" <?php } ?>><?php } ?>
                                
                               	<div class="pill" style="background-image: url('<?php echo base_url(); ?>assets/img/collections/<?php echo $row->collection_profile_image; ?>');">&nbsp;</div>
                                    <p class="label"><?php echo substr($row->collection_title,0,40);?></p>
                                    <p class="options">
                                    <span id="setting_id"><?php echo "<a  href=".base_url()."collections/collection_setting/$row->collection_id>Settings</a>";?><span class="pipe">|</span><a href="<?php echo base_url()?>collections/collection_manage/<?php echo $row->collection_id; ?>">Manage</a></span>
                                    </p>
        ...
        <div class="scroller"><!-- this is for emulating position fixed of the nav -->
            <div class="scroller-inner">
                ...
                <main id="contentContainer">
                    ...
                    <form action="<?php echo base_url(); ?>collections/collection_search" method="post" enctype="multipart/form-data" name="search_form" id="search_form">
                    <ul class="leftPaneFilters">
                        ...
                        <li><a href="<?php echo base_url(); ?>collections/all_collection"><button type="button" />View All</button></a></li>
                            ...
                            <ul class="cardsBox">                                 
                               ...
                               <?php  if(isset($query) && $query!='') { ?>                               	
								...
								<?php if(!empty($query)) {?> <li<?php if($row->collection_id==$query[0]->collection_id ) { ?> class="selected" <?php } ?>><?php } 								
								else {?> <li<?php if($row->collection_id==$this->uri->segment(3)) { ?> class="selected" <?php }else{ ?> style="border:1px solid #535a60"<?php } ?>><?php } ?>            
                        ...
                        <?php if(isset($query[0]->collection_title)){ ?>
                            <h2 class="edit" id="edit"><?php echo $query[0]->collection_title;?></h2>
                             <input type="hidden" id="collection_id" name="collection_id" value="<?php echo $query[0]->collection_id; ?>" />
                            <?php } ?>
                               ...
                               <div class="col span_9 note "><?php if(isset($count_designs) && $count_designs!=''){ echo $count_designs;}else{echo '0';} ?> Designs in this Collection</div>
                                 <div class="col span_7">
                                    <a href="<?php echo base_url()?>collections/collection_manage/<?php echo $query[0]->collection_id; ?>">
                               		     <button class="editPage">Manage Collection</button>
                                    </a>
                                 </div>
                              </div>
                              <?php } ?>
                            
        <form action="<?php echo base_url();?>collections/add_collection" method="post" id="my_form" <?php  if(isset($query) && $query!='') { ?>  style="display:block;" <?php }else { ?> style="display:none;" <?php }  ?> enctype="multipart/form-data">
				...
				<?php if(!isset($query)){?>
                        ...
                        <div class="labelInfo col span_4" style="color:#00A3E8" id="error_title">Collection Title</div>
                        <input style="width: 100%; height: 44px;" autocomplete="off" name="txt_collection_title" id="title_id" onkeyup="titletext(this.value)">
                        </div>
                        <?php } ?>  
<!-- Status -->                            

                            <div class="splitPaneRightRow <?php  if(isset($query[0]->collection_status)  && $query[0]->collection_status==1) {?> statusGreen <?php } else if(isset($query[0]->collection_status)  && $query[0]->	collection_status==0){ ?>statusRed <?php } ?>">
                            <h3  onclick="showSplitPlaneRow(this);">Status</h3><div class="splitPlaneQuickDetails" id="form_act_id"><?php if(isset($query[0]->	collection_status) && $query[0]->collection_status==1){echo 'Active';}else{echo 'Paused';}?></div>
                                <ul class="splitPaneRightDetails">
                                    <li class="row">
                                      <div class="labelInfo col span_4">Status</div>
                                      <div class="formInfo col span_12">
                                       <select name="collection_status" class="">
                                        <option value="1" <?php if(isset($query[0]->collection_status) && $query[0]->collection_status==1){ echo 'selected';} ?>>Active</option>
                                           <option value="0" <?php if(isset($query[0]->collection_status) && $query[0]->collection_status==0){ echo 'selected';} ?>>Paused</option>
                                            </select>
...
<!-- Placement -->          <div class="splitPaneRightRow">
                               <h3  onclick="showSplitPlaneRow(this);">Profile</h3><div class="splitPlaneQuickDetails" id="form_detail_id"><?php if(isset($query[0]->collection_profile_title)) echo $query[0]->collection_profile_title; ?></div>
                                <ul class="splitPaneRightDetails">
                                
                                  
                                  <?php if(isset($query[0]->collection_profile_image)){ ?>
                                  <li class="row">
                                  <div style="float:left;padding-left:127px"><img src="<?php echo base_url(); ?>assets/img/collections/<?php echo $query[0]->collection_profile_image; ?>" height="100" width="100" /></div>
                                 ...
                                 <?php } ?>
                                  ...
                                  <div id="loader" style="display:none;">
                                    ...
                                    <div class="formInfo col span_12"><input type="file"  name="collection_image" class="halfSize" /></div>
                                    </li>
  ...
  <!-- Placement -->                           
						     ...
						     <?php if(isset($allaccount) && $allaccount!='false') { ?>
                                   <li class="row">
                                    ...
                                    <select id="s4" multiple="multiple" name="accounts_select[]">
                                            ...
                                            <option value="<?php echo $row->account_id;?>" <?php if(isset($collectionaccount) && $collectionaccount!='' && isset($postback)) if(in_array($row->account_id, $postback)){ echo "selected";}?>><?php  echo substr($row->account_title ,0,17);?>...</option>
                                              <?php  } ?>
                                              <?php }?>
                                    </select>
    								</p>                                
                ...
                <option value="<?php echo $row->id;?>"<?php if(isset($collectionwebsite) && $collectionwebsite!=''  && isset($postbackweb)) if(in_array($row->id, $postbackweb)){ echo "selected";}?>><?php  echo substr($row->	website_title ,0,17);?>...</option>
                                            <?php } ?>
                                            </select>
                                            </p>
										</div>
...
<!-- Tags -->                            
                            <div class="splitPaneRightRow" >
                            <?php if(isset($query[0]->collection_tags)){
								$tag_collection = rtrim($query[0]->collection_tags,',');
								$tags=explode(',',$tag_collection);
								$tags_count=count($tags);
							}
								?>
                                <h3  onclick="showSplitPlaneRow(this);">Tags</h3><div class="splitPlaneQuickDetails" id="form_tag_id"><?php if(isset($query[0]->collection_tags) &&$query[0]->collection_tags!=''){ echo $tags_count;} else{echo '0';}?> Tags</div>
                                <ul class="splitPaneRightDetails">
                                    <li class="row">
                                        <div class="labelInfo col span_4">Tags</div>
                                        <div class="formInfo col span_12"><textarea name="txt_tag" class="doubleHeight"/><?php if(isset($query[0]->collection_tags)) echo $query[0]->collection_tags; ?></textarea></div>
                                    </li>
                                </ul>
                            </div>
<!-- Notes-->                            
                            <div class="splitPaneRightRow" >
                                ...
                                <ul class="splitPaneRightDetails">
                                   <li class="row">
                                    ...
                                    <div class="formInfo col span_12"><textarea name="txt_note" class="doubleHeight"/><?php if(isset($query[0]->collection_note)) echo $query[0]->collection_note; ?></textarea></div>
                                   </li>
                                </ul>
                            </div>
                             <input type="hidden" id="hidden_collection_id" value="<?php if(isset($query[0]->collection_id)) { echo $query[0]->collection_id; } else{ echo $this->uri->segment(3); } ?>" name="hiddenid"/>   
...
$(document).ready(function() {
	...
	if (r == true) {
		...
		window.location.href='<?php echo base_url() ?>collections/collection_delete/'+del_id;
	} else {
