                ...
                <main id="contentContainer"><!--<div class="message" style="float:right; margin-right:255px;">Account Create Successfully.</div>-->
                    ...
                    <a href="<?php echo base_url(); ?>agency/all_agency"><li><button type="button" />View All</button></li></a>
                        ...
                        <?php } ?>                                                    
                            ...
                            <div class="splitPaneRightRow">
                                <h3  onclick="showSplitPlaneRow(this);">Profile</h3><div class="splitPlaneQuickDetails" id="form_pro_id"><?php if(isset($query[0]->account_profile_address)) echo $query[0]->account_profile_address; ?></div>
                                <ul class="splitPaneRightDetails">
                                    ...
                                    <div class="formInfo col span_12"><input type="file"  name="account_image" id="account_image" class="halfSize" /><input type="button" id="upload_img_btn" value="Upload" /></div>
                                    </li>
                                    <?php } ?>
                                    <li class="row">
                                        <div class="labelInfo col span_4">Address</div>
                                        <div class="formInfo col span_12"><input type="text" name="txt_address" value="<?php if(isset($query[0]->account_profile_address)) echo $query[0]->account_profile_address; ?>" id="address_id" onkeyup="address(this.value)" /><!--<span class="required" id="error_id"></span>--></div>
                                    </li>
                                        ...
                                        <div class="formInfo col span_12">
                                            <select name="lst_country">
                                               <?php if(isset($country_data)){
												foreach($country_data as $row_country){	
												?>
                                              <option style="color:#fff" <?php if(isset($query[0]->account_profile_country)){if($query[0]->account_profile_country==$row_country->idCountry){echo 'selected=selected';}}  ?> value="<?php echo $row_country->idCountry; ?>" <?php if($row_country->sort_by==3){ echo 'disabled=disabled';} ?>><?php echo $row_country->countryName; ?></option>
                                                <?php }} ?>
                                            </select>                                
                                        </div>
                                    </li>
                                    ...
                                    <li class="row">
                                        <div class="labelInfo col span_4">Phone</div>
                                        <div class="formInfo col span_12"><input class=""  type="tel" id="phone_one_id" name="txt_profPhone" value="<?php if(isset($query[0]->account_profile_phone)) echo $query[0]->account_profile_phone; ?>" /><span class="required" id="phone_first_required"></span></div>
                                    </li>
                                    ...
                                    <li class="row">
                                        ...
                                        <select class="" name="lst_timezone">
												...
												foreach($timezone_data as $row_timezone){	
												?>
                                                <option <?php if(isset($query[0]->account_profile_timezone)){if($query[0]->account_profile_timezone==$row_timezone->id){echo 'selected=selected';}}  ?> value="<?php echo $row_timezone->id; ?>"><?php echo $row_timezone->timezone_location.' '.$row_timezone->gmt; ?></option>
                                                <?php }} ?>
