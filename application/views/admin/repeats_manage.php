                    ...
                    <div class="headerSubSubSectionBox">
                        ...
                        <div class="row">
                            <div class="left format-options col span_5">
                                  ...
                                  <select class="custom" id="heading_option_id">
                                    ...
                                    <select id="allignment" <?php /*?>onchange="get_allignment(this.value)"<?php */?>>
                                    ...
                                    <select id="listing" <?php /*?>onchange="get_listing(this.value)"<?php */?>>
                                        <option value="0">None</option>
									...
									function get_heading(value_select){
										
										$('#heading_hidden_id').val(value_select);
									 	if(value_select=='p'){
											CKEDITOR.tools.callFunction(109, 'p'); return false;
											
										}
										if(value_select=='h1'){
											
											CKEDITOR.tools.callFunction(109, 'h1'); return false;
											
										}
										if(value_select=='h2'){
											CKEDITOR.tools.callFunction(109, 'h2'); return false;
											
										}
										if(value_select=='h3'){
											CKEDITOR.tools.callFunction(109, 'h3'); return false;
											
										}
										if(value_select=='h4'){
											CKEDITOR.tools.callFunction(109, 'h4'); return false;
											
										}
										if(value_select=='h5'){
											CKEDITOR.tools.callFunction(109, 'h5'); return false;
											
										}
										if(value_select=='h6'){
											CKEDITOR.tools.callFunction(109, 'h6'); return false;
											
										}
										
									}
									
									function get_allignment(value_select){
									    $('#alignment_hidden_id').val(value_select);
										if(value_select=='left'){
											CKEDITOR.tools.callFunction(24, this); return false;
										}
										if(value_select=='center'){
											CKEDITOR.tools.callFunction(27, this); return false;
										}
										if(value_select=='right'){
											CKEDITOR.tools.callFunction(30, this); return false;
										}
										if(value_select=='justify'){
											CKEDITOR.tools.callFunction(21, this); return false;
										}
										if(value_select=='indent'){
											CKEDITOR.tools.callFunction(33, this); return false;
										}
										if(value_select=='clear'){
											CKEDITOR.tools.callFunction(42, this); return false;
										}		
									}
									
									function get_listing(value_select){
										$('#list_hidden_id').val(value_select);
										if(value_select=='bullet'){
											CKEDITOR.tools.callFunction(39, this); return false;
										}
										if(value_select=='number'){
											CKEDITOR.tools.callFunction(36, this); return false;
										}
									}
									
									function get_style(value_select){
										$('#style_hidden_id').val(value_select);
										if(value_select=='underline'){
											CKEDITOR.tools.callFunction(12, this); return false;
										}
										if(value_select=='strikethrough'){
											CKEDITOR.tools.callFunction(15, this); return false;
										}
										if(value_select=='superscript'){
											CKEDITOR.tools.callFunction(48, this); return false;
										}
										if(value_select=='subscript'){
											CKEDITOR.tools.callFunction(45, this); return false;
										}
										if(value_select=='clearformat'){
											CKEDITOR.tools.callFunction(42, this); return false;
										}
										
									}
									/*$('#underline').click(function(){alert("here");
										CKEDITOR.tools.callFunction(12, this); return false;
									});*/
									</script>
                                    
                                    <select id="styles" <?php /*?>onchange="get_style(this.value)"<?php */?>>
                                         <option value="0">None</option>
                ...
                <div class="headerSubSubSection" id="websites-pages-manage--insert_layout">
                    ...
                    <div class="headerSubSubSectionBox">
                        ...
                        <div class="row">
                            ...
                            <div class="boxButtons col span_9">
                            	<a href="javascript:void(0)"><button type="button" id="cancel_layout" class="cancel">Cancel</button></a>
                                <button type="button" id="save_layout" class="save">Save</button>
                            </div>
                        </div>
	...
	switch(sel.value) {
		...
		case "text": 
			...
			break;
                        ...
                        <div id="1_column_hidden" class="full col span_16">
                        <ul class="row gutters cardsBoxInsertLayout">
                      ...
                      <div id="2_even_column_hidden" class="full col span_16">
                       <ul class="row gutters cardsBoxInsertLayout default">
	                                <li class="col span_2 hidden">&nbsp;</li>
                                    <li class="col span_6">
                      ...
                      <div id="2_colum_width_left" class="full col span_16">
                      <ul class="row gutters cardsBoxInsertLayout">
	                                <li class="col span_2 hidden">&nbsp;</li>
                                     <li class="col span_8">
                      ...
                      <div id="two_column_wideright" style="display:none">
                       <div id="2_colum_width_right" class="full col span_16">
                      ...
                      <div id="3_colum_even" class="full col span_16">
                      <ul class="row gutters cardsBoxInsertLayout">
	                                <li class="col span_2 hidden">&nbsp;</li>
                                    <li class="col span_4">
                      ...
                      <div id="3_colum_widleft" class="full col span_16">
                      <ul class="row gutters cardsBoxInsertLayout">
	                                <li class="col span_2 hidden">&nbsp;</li>
                                    <li class="col span_6">
                      ...
                      <div id="3_colum_widemiddle" class="full col span_16">
                      <ul class="row gutters cardsBoxInsertLayout">
	                                <li class="col span_2 hidden">&nbsp;</li>
                                    <li class="col span_3">
                                        <p class="label">
                      ...
                      <div id="3_colum_wideright" class="full col span_16">
                      <ul class="row gutters cardsBoxInsertLayout">
	                                <li class="col span_2 hidden">&nbsp;</li>
                                    <li class="col span_3">
                                      <p class="label">
                      ...
                      <div id="4_colum_even" class="full col span_16">
                      <ul class="row gutters cardsBoxInsertLayout">
	                                <li class="col span_2 hidden">&nbsp;</li>
                                    <li class="col span_3">
                                       <p class="label">
                     ...
                     <div id="4_colum_wideleft" class="full col span_16">
                     <ul class="row gutters cardsBoxInsertLayout">
	                                <li class="col span_2 hidden">&nbsp;</li>
                                    <li class="col span_6">
                                        <p class="label">
                     ...
                     <div id="4_colum_wideright" class="full col span_16">
                ...
                <div class="headerSubSubSection" id="websites-pages-manage--view">
                    ...
                    <div class="headerSubSubSectionBox">
                        ...
                        <div class="row">
                            ...
                            <div class="boxButtons col span_9">
                            	<a href="javascript:void(0)"><button id="cancel_view" type="button" class="cancel">Cancel</button></a>
...
?>
                ...
                <!--- CH WEBSITE HOME -->
                <div class="codeBox">
                <form id="form_editor" action="<?php echo base_url() ?>repeat_controller/update" method="post">
                <input type="hidden" name="repeat_id" value="<?php echo $edit_id; ?>" />
...
$('#repeat_image_id').click(function(){
	$.ajax({
...
$('#save_repeat_editor').click(function(){
$('#form_editor').submit();
});
$('#cancel_repeat_editor').click(function(){
	history.back();
});
...
$('#repeat_video_id').click(function(){
