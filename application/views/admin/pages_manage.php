...
//$db['default']['username'] = 'devtanae_perk';
                ...
                <div class="headerSubSubSection" id="websites-pages-manage--format_options">
                    ...
                    <div class="headerSubSubSectionBox">
                        ...
                        <div class="row">
							...
							{
								updated_text = '<ul style="padding-left:45px"><li style="list-style:disc;">'+updated_text+'</li></ul>';
...
function set_url_repeat(repeat_id){
	...
	$.ajax({
			...
			success: function(data) {
				...
				$('#hidden_content').val('<repeat id='+split_data[1]+'></repeat>');
...
window.location.href='<?php echo base_url()?>pages_controller/manage_page/'+page_id;	
}

$('#visit_website').click(function(){
	//alert("here");
	var website_id = <?php echo $this->uri->segment(3); ?>;
	$.ajax({
			url: '<?php echo base_url(); ?>ajax/go_website',
			type: 'POST',
			data: 'id_website='+website_id,
			success: function(data) {
				//$('#hidden_content').val(data);
				window.location.href='http://prk.dev.tanaej.com?data='+data;
				//$('#websites_videos').html(data);
			}
	});
});
